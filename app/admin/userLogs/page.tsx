  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="flex md:flex-row gap-6">
        ...
        <table className="w-full table-auto text-sm bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 p-6">
            ...
            {logs.length === 0 && !loading ? (
              ...
              logs.slice(0, 20).map(log => (
                <tr key={log._id} className="border-b">
                  ...
                  <td className={`p-2 font-medium ${log.status === 'SUCCESS' ? 'text-green-600' : 'text-red-600'}`}>
                    {log.status}
                  </td>
                </tr>
              ))
